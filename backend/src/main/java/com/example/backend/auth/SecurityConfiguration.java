  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http.authorizeHttpRequests(customizer -> {
      customizer
          ...
          .requestMatchers(antMatcher(HttpMethod.POST, "/api/notifications/subscribe")).permitAll()
    ...
    http.oauth2Login(customizer -> {
      customizer.successHandler(oauth2LoginSuccessHandler); // oauth2LoginSuccessHandler will be invoked once the oauth2 login flow is successful
    });
