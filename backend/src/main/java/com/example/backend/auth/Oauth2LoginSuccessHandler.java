...
public class Oauth2LoginSuccessHandler implements AuthenticationSuccessHandler {
  ...
  public void onAuthenticationSuccess(
    ...
    System.out.println("onAuthenticationSucces called");
    ...
    if (existingUser != null) {
      ...
      System.out.println("newUser Role: " + newUser.getRole());
      System.out.println("newUser Role Name: " + newUser.getRole().name());
