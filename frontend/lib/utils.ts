...
//   return twMerge(clsx(inputs))
// }
// In modern shadcn/ui and Next.js app structures, utils.ts is intentionally minimal and should only contain the cn() helper.
// My comment: Can move the code else where in future